  ...
  await prisma.categories.createMany({
    data: [
      ...
      },
      {
        ...
        image:
          'https://static.vecteezy.com/system/resources/thumbnails/025/065/286/small/french-fries-with-ai-generated-free-png.png',
        category: 'SIDE-DISH',
      },
      {
        name: 'Sobremesas',
        image:
          'https://static.vecteezy.com/system/resources/previews/021/217/130/original/petit-gateau-dessert-png.png',
        category: 'DESSERT',
      },
    ],
  });
  ...
  await prisma.sideDishe.createMany({
    data: [
      ...
      },
      {
        ...
        description: '10g',
        image:
          'https://static.wixstatic.com/media/11d2b8_14635bf4788d49ac8dece0aeec1957e6~mv2.png/v1/fit/w_500,h_500,q_90/file.png',
      },
      {
        name: 'Molho',
        price: 100,
